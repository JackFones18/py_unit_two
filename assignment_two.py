...
print("")
garden_size = input("How many feet would you like each side of your garden to be? ")
print("")
...
print("navy, blue, skyblue, cyan, turquoise, lightgreen, green, darkgreen, chocolate, brown, black, gray, and white.")
print("")
print("A full list of colors can be found at https://cs111.wellesley.edu/labs/lab02/colors")
print("")
print("Please make sure you type in your color without typos, as a typo will cause the code not to work.")
print("")
...
turtle.write(("The amount of soil required for the center circle is:", circle_volume, "feet cubed."), move=False,
             align="left", font=("arial", 10, "bold"))
move(-200, -305)
turtle.write(("The total amount of soil required for the garden is:", total_flowerbed_volume, "feet cubed."),
